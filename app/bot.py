...
class Model:
    def __init__(self, 
        ...
        self.headers = {"Authorization": f"Bearer {HF_TOKEN}", "Content-Type": "application/json", "Accept": "image/png"}
        self.seed = seed
...
class Bot:
    ...
    def run(self) -> None:
        self.app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, self.query))
